...
func init() {
	...
	beego.Router("/blog/user/:id", &controllers.BlogController{}, "get:User")
	beego.Router("/blog/doc/:id", &controllers.BlogController{}, "get:Doc")
	beego.Router("/blog/book/:id", &controllers.BlogController{}, "get:Book")
}
